...
using Services.Handler.TicketData;
...
builder.Services.AddMediatR(typeof(GetAvailableTicketHandler));
builder.Services.AddValidatorsFromAssemblyContaining(typeof(GetAvailableTicketValidator));
